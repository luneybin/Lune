...
/*
    Shooting for the stars with Luneko!

    Website: https://luneko.co
    Telegram: https://t.me/LunekoToken
...
contract Luneko is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 18400000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 private _tDonationTotal;

    string private _name = "Luneko";
    ...
    uint256 public _maxTxAmount = 18400000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**9;

    address payable public charityAddress = 0x000000000000000000000000000000000000dEaD; // Charity Wallet position if utilized; will be changed as necessary.
